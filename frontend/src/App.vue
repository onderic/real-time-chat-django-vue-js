      ...
      <!-- Main content -->
          <div class="h-screen w-full overflow-y-auto">
            ...
            <div class="px-4 mt-20 py-8">
              <div class="w-1/2 ">
                <h2 v-if="selectedUser" class="bg-white ml-5 rounded-md shadow-md px-4 py-4">Selected User: {{ selectedUser }}</h2>
              </div>
            </div>
            <div class="w-1/2 ml-auto">
              <h2 v-if="selectedUser" class="bg-green-200 mr-5 rounded-md shadow-md px-4 py-4">Selected User: {{ selectedUser }}</h2>
            </div>
